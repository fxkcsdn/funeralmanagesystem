  ...
  <body>
    ...
    <table>
      <tr>
         ...
         <td><select id="carryType" name="carryType" disabled="true"><option value="火化">火化</option><option value="守灵" >守灵</option><option value="冷藏" selected="true">冷藏</option></select></td>
